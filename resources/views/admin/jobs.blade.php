                            ...
                            <td class="text-right">
                                <div class="dropdown dropdown-action">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <a
                                            data-id="{{$job->id}}"
                                            data-route="{{route('jobs.destroy')}}"
                                            class="dropdown-item trash"
                                            href="javascript:void(0)"><i class="fa fa-trash-o m-r-5"></i> Delete</a>
                                    </div>
                                </div>
                            </td>
                        </tr>
				...
				<form method="POST" action="{{route('jobs')}}" enctype="multipart/form-data">
					...
					<div class="row">
						<div class="col-md-12">
							<div class="form-group">
								<label>Description</label>
								<textarea id="e_description" class="form-control summernote" name="description"></textarea>
							</div>
						</div>
					</div>
					<div class="submit-section">
	...
	<script>
		$(document).ready(function (){
			$('.datatable').on('click','.editbtn',function (){
                ...
                $('#e_description').summernote('code', description);
			});
		})
	</script>
@endpush
