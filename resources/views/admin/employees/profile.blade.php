                            ...
                            <div class="row">
                                <div class="col-md-5">
                                    <div class="profile-info-left">
                                        ...
                                        <h6 class="text-muted">Department: {{$user->employee->department->name}}</h6>
                        ...
                        <div class="card-body">
                            ...
                            <ul class="personal-info">
                                ...
                                <li>
                                    ...
                                    <div class="text">{{$employee->bank_information['bank_name']}}</div>
                                </li>
                                <li>
                                    <div class="title">Bank account No.</div>
                                    <div class="text">{{$employee->bank_information['account_number']}}</div>
                                </li>
                                <li>
                                    <div class="title">Bank Branch</div>
                                    <div class="text">{{$employee->bank_information['bank_branch']}}</div>
                                </li>
                                <li>
                                    <div class="title">Sort Code</div>
                                    <div class="text">{{$employee->bank_information['sortcode']}}</div>
                                </li>
                                <li>
                                    <div class="title">IFSC Code</div>
                                    <div class="text">{{$employee->bank_information['ifsc_code']}}</div>
                                </li>
                                <li>
                                    <div class="title">PAN No</div>
                                    <div class="text">{{$employee->bank_information['pan_number']}}</div>
                                </li>
                                @endif
                            </ul>
                        </div>
...
<div id="bank_info_modal" class="modal custom-modal fade" role="dialog">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="{{route('update.bankinfo', $employee)}}">
                    @csrf
                    <div class="form-group">
                        <x-form.input name="bank_name" label="Bank Name"></x-form.input>
                    </div>
                    <div class="form-group">
                        <x-form.input name="account_number" label="Bank Account Number"></x-form.input>
                    </div>
                    <div class="form-group">
                        <x-form.input name="bank_branch" label="Bank Branch Name"></x-form.input>
                    </div>
                    <div class="form-group">
                        <x-form.input name="branch_sortcode" label="Bank Branch Sort Code"></x-form.input>
                    </div>
                    <div class="form-group">
                        <x-form.input name="ifsc_code" label="IFSC"></x-form.input>
                    </div>
                    <div class="form-group">
                        <x-form.input name="pan_number" label="PAN Number"></x-form.input>
                    </div>
                    <div class="submit-section">
                        <button class="btn btn-primary submit-btn">Submit</button>
                    </div>
